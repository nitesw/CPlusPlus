...
int main()
{
   ...
   cout << (day < 10 ? "0" : "") << day << "." << (month < 10 ? "0" : "") << month << "." << year << endl;*/
    ...
    cout << "Enter the 4 digits number: "; cin >> num;
    ...
    {
        cout << "Error! Enter the 4 digits number only!";
    }*/

    int salary = 200, enter_sal;

    cout << "--------------------------------------------------" << endl;
    cout << "Enter sales of the first manager: "; cin >> enter_sal;
    int firstMang, secondMang, thirdMang;
    string bestMang = "";
    if (enter_sal <= 500)
    {
        firstMang = salary + (salary / 100 * 3);
    }
    else if (enter_sal > 500 && enter_sal <= 1000)
    {
        firstMang = salary + (salary / 100 * 5);
    }
    else if (enter_sal > 1000)
    {
        firstMang = salary + (salary / 100 * 8);
    }

    cout << "Enter sales of the second manager: "; cin >> enter_sal;
    if (enter_sal <= 500)
    {
        secondMang = salary + (salary / 100 * 3);
    }
    else if (enter_sal > 500 && enter_sal <= 1000)
    {
        secondMang = salary + (salary / 100 * 5);
    }
    else if (enter_sal > 1000)
    {
        secondMang = salary + (salary / 100 * 8);
    }

    cout << "Enter sales of the third manager: "; cin >> enter_sal;
    if (enter_sal <= 500)
    {
        thirdMang = salary + (salary / 100 * 3);
    }
    else if (enter_sal > 500 && enter_sal <= 1000)
    {
        thirdMang = salary + (salary / 100 * 5);
    }
    else if (enter_sal > 1000)
    {
        thirdMang = salary + (salary / 100 * 8);
    }

    if (firstMang > secondMang && firstMang > thirdMang)
    {
        firstMang += 200;
        bestMang = " first ";
    }
    else if (secondMang > firstMang && secondMang > thirdMang)
    {
        secondMang += 200;
        bestMang = " second ";
    }
    else if (thirdMang > firstMang && thirdMang > secondMang)
    {
        thirdMang += 200;
        bestMang = " third ";
    }
    ...
    if (bestMang == "")
    {
        cout << "There are no best managers." << endl;
    }
    else
    {
        cout << "The best manager is the" << bestMang << "manager. He receives 200 additional USD." << endl;
    }
    cout << "So the salary of the first manager is: " << firstMang << endl;
    cout << "So the salary of the second manager is: " << secondMang << endl;
    cout << "So the salary of the third manager is: " << thirdMang << endl;
    cout << "--------------------------------------------------" << endl;

    /*Також зробив всі задані завдання які були на практичну, так як на двох парах мене не було.*/
}
...
{
	double priceUAH = product.price * dollars;
	string text = "Product #" + to_string(number);
	cout << "\n\t ================ " << text << " ================\n";
	cout << "\t\t " << product.type << ": ";
	cout << product.brand << " ";
...
int main()
{
	...
	fstream file("store.txt", ios_base::in);
	fstream currency("currency.txt", ios_base::in);
	if (!file.is_open())
	{
		fstream currency("currency.txt", ios_base::out);
		cout << "\n\t\t Enter the price of a dollar: ";
		cin >> dollars;
		currency << dollars;
		currency.close();
	}
	...
	do
	{
		...
		{
			fstream currency("currency.txt", ios_base::out);
			cout << "\n\t\t Enter the new price of a dollar: ";
			cin >> dollars;
			currency << dollars;
			currency.close();
			break;
